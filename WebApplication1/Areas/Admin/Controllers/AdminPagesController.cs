...
namespace WebApplication1.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public AdminPagesController(Se1708Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDesc,MetaKey,Alias,CreatedAt,Ordering")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (ModelState.IsValid)
            {
                if (fThumb != null)
                {
                    ...
                    string imageName = Ultilities.SEOUrl(page.PageName) + extension;
                    page.Thumb = await Ultilities.UploadFile(fThumb, @"pages", imageName.ToLower());
                }
        ...
        {   
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    page.PageName = Ultilities.ToTitleCase(page.PageName);
