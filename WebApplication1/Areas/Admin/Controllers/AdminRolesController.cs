...
{   
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(Se1708Context context , INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("RoleID,RoleName,Description")] Roles role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleID,RoleName,Description")] Roles role)
        {
            if (id != role.RoleID)
            {
                return NotFound();
